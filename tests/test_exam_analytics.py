...
class ExamAnalyticsTests(unittest.TestCase):
    ...
    def test_service_computes_exam_and_question_analytics(self):
        ...
        self.assertAlmostEqual(summary["median_score"], 3.0)
        self.assertAlmostEqual(summary["pass_rate"], 50.0)
        self.assertAlmostEqual(summary["standard_deviation"], 3.0)
