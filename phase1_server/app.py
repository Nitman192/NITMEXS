...
def create_app(
    ...
    if db_path is not None:
        active_settings = AppSettings(
            ...
            ai_mode=active_settings.ai_mode,
            ai_base_url=active_settings.ai_base_url,
            ai_timeout_seconds=active_settings.ai_timeout_seconds,
            ai_model_name=active_settings.ai_model_name,
            ai_enabled_features=active_settings.ai_enabled_features,
