(() => {
  const catalog = {
    strings: {
      ...
      "admin.create_exam": "Create Exam",
      "admin.publish_exam": "Activate / Publish",
      "admin.close_exam": "Close Exam",
      "admin.delete_exam": "Delete Selected Exam",
      ...
      "admin.custom_rules_placeholder": "One custom rule per line. Default rules always remain active.",
      "admin.save_custom_rules": "Save Custom Rules",
      "admin.question_type_mcq": "MCQ",
      "admin.question_type_true_false": "True / False",
      "admin.question_type_fib": "Fill in the Blanks",
      "admin.question_type_short": "Short Answer",
      "admin.question_type_long": "Long Answer",
      "admin.question_topic_placeholder": "Topic",
      "admin.difficulty_easy": "Easy",
      "admin.difficulty_medium": "Medium",
      "admin.difficulty_hard": "Hard",
      "admin.question_marks_placeholder": "Marks",
      "admin.question_text_placeholder": "Question text",
      "admin.question_options_placeholder": "MCQ format: Option text :: true/false\nFIB format: one accepted answer per line\nTrue/False: write True or False on one line",
      "admin.word_target_min_placeholder": "Word target min",
      "admin.word_target_max_placeholder": "Word target max",
      "admin.word_hard_max_placeholder": "Word hard max",
      "admin.create_question": "Create Question",
      "admin.preview_fib_title": "Fill in the blank",
      "admin.preview_short_title": "Short answer",
      "admin.preview_long_title": "Long answer",
      "admin.preview_mcq_title": "MCQ",
      "admin.preview_true_false_title": "True / False",
      "admin.preview_fib_placeholder": "Cadet types the missing word here",
      "admin.preview_subjective_placeholder": "Cadet writes the answer here",
      "admin.preview_accepted_answers": "Accepted answers",
      "admin.preview_word_policy": "Word policy",
    ...
    pages: {
      ...
      admin: {
        ...
        text: {
          ...
          "#create-exam": "admin.create_exam",
          "#publish-exam": "admin.publish_exam",
          "#close-exam": "admin.close_exam",
          "#delete-exam": "admin.delete_exam",
          ...
          "#save-custom-rules": "admin.save_custom_rules",
          ...
          "#question-type option[value='mcq_single']": "admin.question_type_mcq",
          "#question-type option[value='true_false']": "admin.question_type_true_false",
          "#question-type option[value='fib_text']": "admin.question_type_fib",
          "#question-type option[value='short_answer']": "admin.question_type_short",
          "#question-type option[value='long_answer']": "admin.question_type_long",
          ...
          "#create-question": "admin.create_question",
        ...
        attrs: {
          ...
          "#custom-rules-text": { placeholder: "admin.custom_rules_placeholder" },
          "#question-topic": { placeholder: "admin.question_topic_placeholder" },
          "#question-marks": { placeholder: "admin.question_marks_placeholder" },
          "#question-text": { placeholder: "admin.question_text_placeholder" },
          "#question-options": { placeholder: "admin.question_options_placeholder" },
          "#word-target-min": { placeholder: "admin.word_target_min_placeholder" },
          "#word-target-max": { placeholder: "admin.word_target_max_placeholder" },
          "#word-hard-max": { placeholder: "admin.word_hard_max_placeholder" },
        },
      },
    },
  };
